  ...
  return <div className="space-y-5">
    ...
    <div className="grid gap-5 xl:grid-cols-[1.15fr_.85fr]">
      <div className="space-y-5">
        ...
        <Panel>
          <div className="border-b border-white/8 px-5 py-4"><div className="text-sm font-medium">Demo questions</div><div className="mt-1 text-xs text-slate-500">Run these across v2, v3, and v4 to show visible improvement.</div></div>
